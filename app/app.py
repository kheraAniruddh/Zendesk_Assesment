...
def index():
	...
	name = None
	return render_template("index.html", name = Config.AGENT_EMAIL)
...
def viewAllTickets():
	...
	if 'page' in request.args:
		...
		return abort(404)	
	result = util.makeRequest(Config.ZENDESK_BASE_URL + 'tickets.json?page='+pageNo)	
...
def viewTicketDetails():
	...
	if 'ticketId' in request.args:
		...
		return abort(404)
	result = util.makeRequest(Config.ZENDESK_BASE_URL + 'tickets/'+ ticketId+'.json')
